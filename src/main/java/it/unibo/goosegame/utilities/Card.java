...
public enum Card {
    ...
    NAME1("Dora the Zdora", "descrizione1", 4, false, false, false),
    /** Carta bonus di esempio 2. */
    NAME2("Franco Letame", "descrizione2", 6, false, false, false),
    /** Carta bonus di esempio 3. */
    NAME3("Furio", "descrizione3", 10, false, false, false),
    /** Carta bonus di esempio 4. */
    NAME4("Pijacked", "descrizione4", 8, true, true, false),
